...
const RootLayout = observer(() => {
  ...
  useEffect(() => {
    // When the route changes and there is no filter or oldFilter in the search params, remove all filters.
    if (prevPathname !== pathname && !searchParams.has("filter") && !searchParams.has("oldFilter")) {
